...
Plans:
- [ ] 07-01-PLAN.md — A 區塊 TimeProvider (DI 註冊 + check-no-datetime-now.py + pre-commit + FakeTimeProviderFixture + CONVENTIONS 段 + F-007 status draft -> approved -> implementing) (AC-A1, A2, A3, A4, A5, A6)
